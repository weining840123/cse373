...
public class LinkedIntList {
    ...
    public static void extend(LinkedIntList A, LinkedIntList B) {
        ...
        ListNode bFirst = B.front;
        ListNode aLast = A.front;
    ...
    public static LinkedIntList concatenated(LinkedIntList A, LinkedIntList B) {
        ...
        ListNode concateALast = concatPart(A, newLast);
        ListNode concateBLast = concatPart(B, concateALast);

        LinkedIntList newLinkedList = new LinkedIntList();
        newLinkedList.front = dummy.next;
        ...
        ListNode aCur = A.front;
        while (aCur != null) {
            ListNode nextNode = new ListNode(aCur.data, null);
        ...
        while (bCur != null) {
            ListNode nextNode = new ListNode(bCur.data, null);
            newLast.next = nextNode;
            bCur = bCur.next;
            newLast = newLast.next;
        }
    ...
    public static ListNode concatPart(LinkedIntList L, ListNode last) {
        ListNode lCur = L.front;
        while (lCur != null) {
            ListNode nextNode = new ListNode(lCur.data, null);
            last.next = nextNode;
            lCur = lCur.next;
            last = last.next;
        }
